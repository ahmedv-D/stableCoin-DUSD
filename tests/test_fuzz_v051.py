...
OUT = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                   "docs", "FUZZ-V0.5.1-DUSD-RESULTS-v051.json")
...
def run_fuzz_v051(rounds: int = FUZZ_ROUNDS, seed: int = SEED) -> dict:
...
def test_fuzz_v051_100k_sequences_zero_invariant_violations():
    r = run_fuzz_v051(FUZZ_ROUNDS, SEED)
